...
/* 	changing INPUT and OUTPUT values is Recommended while dealing with different hardware that treats 0
	as output and 1 as input (PIC families)  */
#define INPUT 0
#define OUTPUT 1

/* changing the LOGIC_HIGH and LOGIC_LOW values dictates whether we are dealing with pull up or pull down configurations */
#define LOGIC_HIGH 1
#define LOGIC_LOW 0
...
[in]   		const DioConfig * a_CONFIG_MSG_Ptr :
			receives the address of  the DioConfig struct containing all information about the targeted registers
...
[in]   	const DioConfig * a_STATE_Ptr :
		receives the address of  the DioConfig struct containing all information about the targeted registers of the hardware
